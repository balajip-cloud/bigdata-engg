...
class ETLSQL:
    ...
    def write_to_parquet(self, df: DataFrame, table_name: str, key_field: str):
    ...
    def run(self):
        ...
        self.write_to_parquet(processed_customers, "customers", "customer_id")
        self.write_to_parquet(processed_products, "products", "product_id")
        self.write_to_parquet(processed_transactions, "transactions", "transaction_id")
